...
function Dmg()
    ...
    -- Assuming 1092616192 is the base damage, we change it to a 50% equivalent if required.
    -- Update this number if 50% is tied to a different value.
    gg.editAll("1092616192 * 1.5", gg.TYPE_DWORD)  -- Modify this to the correct value or multiplier
